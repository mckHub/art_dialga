...
function decrypt($encryptedDataWithIV, $key) {
  // Decode the base64-encoded string
  $encryptedDataWithIV = base64_decode($encryptedDataWithIV);

  // Extract the IV from the beginning of the string
  $iv_length = openssl_cipher_iv_length('AES-256-CBC');
  $iv = substr($encryptedDataWithIV, 0, $iv_length);

  // Extract the encrypted data from the rest of the string
  $encryptedData = substr($encryptedDataWithIV, $iv_length);
...
-->
      ...
      <div class="collapse navbar-collapse justify-content-end align-center" id="main-nav">
        <ul class="navbar-nav" >
          ...
          <li class="nav-item"> 
            <a class="nav-link "  href="../pages/gallerie.php">Gallerie</a>
          </li>
          <li class="nav-item">
      ...
      <div class="row justify-content-center align-items-center ">
        ...
        <div class="col-md-5 text-center  d-md-block " >
          ...
          <span class="tt" data-bs-placement="bottom" title="Sport spirtuel pour la purification de l'ame">
            ...
            <p>
            <a style="margin-top:8px" href="pages/commandes.php?nomtableau=<?= urlencode("Sport spirituel pour la purification de l'âme") ?>&email=<?= urlencode($emailuser) ?>&prix=900 €" class="btn" id="buttoncustomize">Commandez</a>
...
<div class=" " >
  ...
  <p style="text-decoration: none; color: inherit;margin-bottom:5px;">Gallerie</p>
    <!-- Image 1 -->
  ...
  <p style="text-decoration: none; color: inherit;margin-bottom:5px;">Profil</p>
    <!-- Image 1 -->
...
Hassane Dialga est un artiste peintre basée à Ouagadougou, Burkina Faso...
	...
	<center><h3 style="margin-top:60px;"> Vos commandes.</h3></center>
...
?>
    ...
    <tr>
    <td colspan=4 style="font-weight:bold;"><?php echo $row_number ?> Commande(s) </td>
    <td colspan=2 style="font-weight:bold;">Total: <?php echo $total_prix ?> €</td>
        ...
        <div class="" style="margin-top:5px; text-align:center"><a style="font-family: Georgia, 'Times New Roman', Times, serif;text-decoration:none" href="../index.php" class="forgot">Acceuil </a></div>       
